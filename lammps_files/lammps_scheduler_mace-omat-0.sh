...
lmp_in=$DIR/lammps_files/in_nvt_mace # lammps infile, for constant 'NVT' ensemble MD
#lmp_exec=$DIR/lmp_mpi # LAMMPS executable binary file
lmp_exec=$DIR/Executables/graph_pes_lmp # LAMMPS executable binary file
...
pot=$DIR/Potentials/mace-omat-0.pt # filename for the GAP potential that you use for the simulation
