...
lmp_in=$DIR/lammps_files/in_nvt_GAP17 # lammps infile, for constant 'NVT' ensemble MD
#lmp_exec=$DIR/lmp_mpi # LAMMPS executable binary file
lmp_exec=$DIR/Executables/lmp_cpu_mpich_quip # LAMMPS executable binary file
...
pot=$DIR/Potentials/carbon.xml # filename for the GAP potential that you use for the simulation
